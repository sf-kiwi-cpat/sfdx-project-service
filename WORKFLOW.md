# Development Workflow: Brief → Spec → Implement
...
**Handoff:**
Offers next step: `/spec` → define executable contracts
...
**Command:**
```bash
/spec #68                    # Draft from issue
/spec add SSE streaming      # Draft from description
/spec --refresh deploy       # Regenerate prose from tests
```
...
└── .claude/skills/
    ...
    ├── spec/                      # Defining contracts
    └── implement/                 # Implementing contracts
```
...
Located: `.claude/skills/spec/derive-contract.ts`
...
- `.claude/skills/spec/SKILL.md` — Spec skill documentation
